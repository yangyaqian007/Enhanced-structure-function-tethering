            ...
            switch args.DataStyle
                case 'scatter'
                    if ~isempty(data2)
                        jitter = 1*(rand(size(data))); %right
                        obj.ScatterPlot = ...
                            scatter(pos + jitter.*jitterstrength, data, 'filled','MarkerFaceAlpha',0.5);
                        % plot the data points within the violin area
                        ...
                        obj.ScatterPlot2 = ...
                            scatter(pos + jitter.*jitterstrength, data2,  args.MarkerSize,'filled','MarkerFaceAlpha',0.5);         
                    else 
                        obj.ScatterPlot = ...
                            scatter(pos + jitter.*jitterstrength, data, args.MarkerSize, 'filled','MarkerFaceAlpha',0.5);
